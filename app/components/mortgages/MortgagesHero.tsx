    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-off-white">
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h1 className="mx-auto max-w-5xl text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-navy leading-[1.1] mb-8 font-[family-name:var(--font-serif-display)]">
            Mortgage Solutions Built on <span className="text-blue italic">Financial Insight</span> — Not Just Rates
          </h1>
